...
GM_config.init(
    {
        ...
        'fields': // Fields object
        {
            ...
            'theme': {
                ...
                'options': ['Blue', 'Mint', 'Red'], // Possible choices
...
loadScript("https://rawgit.com/hydrabolt/discord.js/webpack/discord.master.js",
    ...
    client.on('ready', () => {
        ...
        if (guildvar === null) {
            ...
            channelvar = guildvar.defaultChannel;
    ...
    client.on('message', msg => {
        ...
        if (guildvar !== null) {
            if (msg.channel.id === channelvar.id) {
                ...
                $("#main_content_section .shout .roundframe .innerframe .message-wrap").append('<span style="color:' + color + ';">' + displayname + "</span><span>: " + escapeHTML(msg.cleanContent, true).autoLink() + '</span><br>');
